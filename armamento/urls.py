...
urlpatterns = [
    ...
    path('editar_armamento/<str:id>',views.editar_armamento, name='editar_armamento'),
    path('eliminar_armamento/<str:id>',views.eliminar_armamento, name='eliminar_armamento'),
