...
def despues_de_insertar(sender, instance, created, **kwargs):
    ...
    ArmamentoLog.objects.create(
        ...
        cuip_portador = instance.CUIP_PORTADOR,
        cuip_responsable = instance.CUIP_RESPONSABLE,
        cihb = instance.CIHB,
        tipo_funcionamiento = instance.TIPO_FUNCIONAMIENTO.TipoFuncionamiento,
        propiedad = instance.PROPIEDAD.Propiedad,
